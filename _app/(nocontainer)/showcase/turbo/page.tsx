...
import { Clients } from "@c/clients/Clients";
import { Marquee } from "@c/clients/Marquee";
import { TurboheroBackground } from "@c/landing/TurboHeroBackground";

import styles from "./index.module.css";
import { Turbopack } from "@/components/landing/Turbopack";
...
function LandingPage(): JSX.Element {
  return (
    <>
      <main className="relative flex flex-col clear-header items-center justify-center w-full h-full  overflow-hidden [--geist-foreground:#fff] dark:[--geist-foreground:#000] [--gradient-stop-1:0px] [--gradient-stop-2:120px] sm:[--gradient-stop-1:0px] sm:[--gradient-stop-2:120px]">
        <Background />
