...
const socials = [
    {
        ...
        href: 'https://twitter.com/remcostoeten_',
        label: 'Twitter',
        handle: '@remcostoeten_',
    },
    {
        icon: <Mail size={20} />,
        href: 'mailto:dev@remcostoeten.com',
        label: 'Email',
        handle: 'dev@remcostoeten.com',
    },
    {
        icon: <Github size={20} />,
...
export default function Example() {
    return (
        <div className=" bg-gradient-to-tl from-
        zinc-900/0 via-zinc-900 to-zinc-900/0">
            <Navigation />
            <div className="container flex items-center justify-center min-h-screen px-4 mx-auto">
                <div className="grid w-full grid-cols-1 gap-8 mx-auto mt-32 sm:mt-0 sm:grid-cols-3 lg:gap-16">
                    {socials.map((s) => (
                        <div>
                            <Link href={s.href} target="_blank" className="relative flex flex-col items-center gap-4 p-4 duration-700 group md:gap-8 md:py-24 lg:pb-48 md:p-16">
                                ...
                                <div className="z-10 flex flex-col items-center">
                                    <span className="text-xl font-medium duration-150 lg:text-3xl text-zinc-200 group-hover:text-white font-display">{s.handle}</span>
