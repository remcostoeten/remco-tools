    ...
    return (
        <section ref={ref} id="home" className="mb-28 mx-auto max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
            ...
            <motion.h1 className="mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-4xl" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }}>
                <span className="font-bold">Hello, I'm Remco.</span> I'm a <span className="font-bold">front-end developer</span> with <span className="font-bold">~7 years</span> of experience. I
                enjoy building things, <span className="italic">with scode</span>. My current focus is <span className="underline">Next.js</span>.
            </motion.h1>
