...
import GreenCursor from '@/components/core/icons/Cursor/GreenCursor';
import PinkCursor from '@/components/core/icons/Cursor/PinkCursor';
...
const CustomCursor = () => {
    ...
    return (
        ...
        >
            {isAlternative ? <PinkCursor style={undefined} /> : <GreenCursor />}
        </motion.div>
    );
};
