...
export default async function TaskPage() {
    return (
        <>
            <div className="flex h-full w-screen flex-1 flex-col space-y-8  p-8 md:w-[60vw]">
                <div className="flex items-center justify-between space-y-2">
                    <div>
                        <h2 className="text-2xl font-bold tracking-tight">Stuff to do 💰</h2>
                        <p className="text-muted-foreground">Just somet tasks or wishes I still have for this site. The endleseless list of things to do. Brain with ideas goes brrrrrrrrrrr 🚀</p>
                    </div>
                </div>
                <DataTable columns={DisplayTasks} data={[]} />
            </div>
        </>
    );
}
