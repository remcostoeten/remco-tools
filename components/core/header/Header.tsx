    ...
    return (
        <>
            <header className='relative z-50 header hidden md:flex showAlternativeCursor'>
                <motion.div
                    className='header width-fill fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none   bg-header  shadow-lg shadow-white/[0.06] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem]  sm:rounded-full '
