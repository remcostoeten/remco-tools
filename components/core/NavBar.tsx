...
export default function NavBar() {
    ...
    return (
        <>
        <NotProd />
        <nav className="hidden sm:block z-10 fixed black-block rounded-full top-0 black-box px-10 left-1/2 h-12 -translate-x-1/2   mt-8 shadow-lg shadow-white/[0.06] backdrop-blur-3xl pr-8 ">
