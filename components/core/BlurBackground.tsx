...
export default function ParallaxEffect() {
    ...
    return (
        <div className="md:top:[-100px] -z-10" id="parallax" style={{ position: 'fixed', top: '0', left: '0' }} ref={parallaxRef}>
            ...
            <div className="-bottom-[100px] left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-[15rem] dark:bg-[#292736] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]"></div>
        </div>
    );
}
