 ...
 */
export default function Particles({ particleCount, className }: ParticlesProps) {
    const particles = [];
    ...
    return <div className={`particles-container particles-container-${particleCount} ${className}`}>{particles}</div>;
}