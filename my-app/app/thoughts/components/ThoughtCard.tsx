...
export default function ThoughtCard() {
  ...
  const handleRemoveAll = async () => {
    try {
      ...
      const deletePromises = snapshot.docs.map((doc: { ref: any; }) => deleteDoc(doc.ref));
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <motion.select
            ...
            value={sortOrder}
            // @ts-ignore
            onChange={(e: { target: { value: string | ((prevState: "asc" | "desc") => "asc" | "desc"); }; }) => setSortOrder(e.target.value)}
          >
            <motion.option
